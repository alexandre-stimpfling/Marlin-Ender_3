...
#define STRING_CONFIG_H_AUTHOR "Alexandre Stimpfling" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "E3 v422 - CR-SEP + BLT"
...
#define HEATER_0_MAXTEMP 315 // Température max. pour Creality Sprite Extruder Pro (direct drive) = 300°(max extruder) + 15°(securité marlin)
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.08  // (mm) Distance from real junction edge // Formule appliquée : 0.4*(10²/500) -> 0.4*(DEFAULT_JERK²/DEFAULT_ACCELERATION)
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -29, -42, -3.90 }
...
#define MIN_SOFTWARE_ENDSTOPS
  ...
  //#define MIN_SOFTWARE_ENDSTOP_Z // Alex : Commenté car impossible de calculer le z-offset nécessaire suite à l'ajout du BLTouch
